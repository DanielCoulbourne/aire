...
use Galahad\Aire\Elements\Typeahead;
...
trait CreatesElements
{
    ...
    /**
     * Create a typeahead element
     *
     * @param string|null $name
     * @param string|\Illuminate\Contracts\Support\Htmlable|null $label
     * @return \Galahad\Aire\Elements\Typeahead
     */
    public function typeahead($name = null, $label = null) : Typeahead
    {
        $typeahead = new Typeahead($this->aire, $this);
        
        if ($name) {
            $typeahead->name((string) $name);
        }
