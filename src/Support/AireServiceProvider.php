...
use Galahad\Aire\Elements\TypeaheadChoices;
...
class AireServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('galahad.aire.plugin.typeahead', function (Application $app, $args) {
            return new TypeaheadChoices($args['typeahead']);
        });
    }
