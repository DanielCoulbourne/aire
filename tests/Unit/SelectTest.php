...
class SelectTest extends TestCase
{
    ...
    public function test_with_javascript_throws_exception_if_aire_select_isnt_installed() : void
    {
        $this->expectExceptionMessage('To use the `Select::withJavascript()` method, please run `composer install internachi/aire-select`');
